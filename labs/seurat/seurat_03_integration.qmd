...
wrap_plots(
  DimPlot(alldata, reduction = "pca", group.by = "orig.ident", shuffle = TRUE)+NoAxes()+ggtitle("PCA raw_data"),
  DimPlot(alldata, reduction = "tsne", group.by = "orig.ident", shuffle = TRUE)+NoAxes()+ggtitle("tSNE raw_data"),
  DimPlot(alldata, reduction = "umap", group.by = "orig.ident", shuffle = TRUE)+NoAxes()+ggtitle("UMAP raw_data"),
  
  DimPlot(alldata, reduction = "integrated_cca", group.by = "orig.ident", shuffle = TRUE)+NoAxes()+ggtitle("CCA integrated"),
  DimPlot(alldata, reduction = "tsne_cca", group.by = "orig.ident", shuffle = TRUE)+NoAxes()+ggtitle("tSNE integrated"),
  DimPlot(alldata, reduction = "umap_cca", group.by = "orig.ident", shuffle = TRUE)+NoAxes()+ggtitle("UMAP integrated"),
  ncol = 3
